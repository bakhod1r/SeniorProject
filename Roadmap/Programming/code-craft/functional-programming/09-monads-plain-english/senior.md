...
- [Over-Engineering](../../anti-patterns/01-development/03-over-engineering/senior.md) — Speculative Generality is the failure mode of reaching for transformer stacks and `Result`-everywhere before the requirement is real.
